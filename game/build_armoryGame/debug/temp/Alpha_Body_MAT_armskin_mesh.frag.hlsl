...
void frag_main()
{
    ...
    float3 basecol = float3(0.096570007503032684326171875f, 0.4216198027133941650390625f, 0.522000014781951904296875f);
    float roughness = 0.80829155445098876953125f;
    float metallic = 0.0f;
