...
@:keep class CharacterAnimation extends armory.logicnode.LogicTree {
	...
	override public function add() {
		...
		_PlayAction.addInput(new armory.logicnode.FloatNode(this, 0.30000001192092896), 0);
		...
		_PlayAction_001.addInput(new armory.logicnode.FloatNode(this, 0.30000001192092896), 0);
