...
project.addParameter('arm.node.Corona');
project.addParameter("--macro keep('arm.node.Corona')");
...
project.addParameter('arm.AnimationHaxe');
project.addParameter("--macro keep('arm.AnimationHaxe')");
